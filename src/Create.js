...
const Create = () => {
    ...
    const handlesubmit=(e)=>{
      e.preventDefault();
      const empdata={name,age,address,phone,active};
                            ...
                            <div className="card-body">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-12">
                                        <div className="form-group">
                                            <label>Name</label>
                                            <input required value={name} onMouseDown={_e=>valchange(true)} onChange={e=>namechange(e.target.value)} className="form-control"></input>
